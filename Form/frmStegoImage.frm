...
Begin VB.Form frmStegoImage 
   ...
   Begin VB.Frame fraPage 
      ...
      Begin MSComDlg.CommonDialog dlgBrowse 
         ...
         _Version        =   393216
         CancelError     =   -1  'True
         DialogTitle     =   "Select Stego Image"
      End
      Begin VB.Frame fraHelp 
         ...
         Begin Chameleon.CustomButton btnHelp 
            ...
            BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
               ...
               Strikethrough   =   0   'False
            EndProperty
            Picture         =   "frmStegoImage.frx":0000
            PictureOffset   =   8
         End
         Begin VB.Label lblHelp 
            BackStyle       =   0  'Transparent
            Caption         =   "Select the image from which to extract hidden data."
            ForeColor       =   &H8000000D&
            Height          =   600
            Index           =   2
            Left            =   180
      ...
      Begin Chameleon.CustomButton btnBrowse 
         ...
         EndProperty
         Padding         =   0
         Picture         =   "frmStegoImage.frx":059A
      End
      Begin VB.Frame fraProperties 
         Caption         =   " Stego Image Properties "
         ClipControls    =   0   'False
         BeginProperty Font 
            Name            =   "Arial"
            Size            =   8.25
         ...
         Begin VB.Frame fraView 
            ...
            Begin Chameleon.CustomButton btnView 
               ...
               BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
                  ...
                  Strikethrough   =   0   'False
               EndProperty
               Picture         =   "frmStegoImage.frx":0B34
            End
         End
      ...
      Begin VB.Image imgPageIcon 
         ...
         Index           =   0
         Left            =   150
         Picture         =   "frmStegoImage.frx":140E
         Top             =   270
         Width           =   480
      End
   ...
   Begin VB.Frame fraNavBar 
      ...
      Begin Chameleon.CustomButton btnCancel 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Picture         =   "frmStegoImage.frx":1CD8
      End
      Begin Chameleon.CustomButton btnNext 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Picture         =   "frmStegoImage.frx":1FFA
      End
      Begin Chameleon.CustomButton btnBack 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Picture         =   "frmStegoImage.frx":231C
         PictureOffset   =   4
      End
   End
End
Attribute VB_Name = "frmStegoImage"
...
Private Sub btnHelp_Click()
  DisplayHelpFile "extract_wizard.html"
End Sub
  ...
  If ActiveControl Is btnView Then
    If Not frmView.DisplayByFilename(, txtPath.Text) Then
      MsgBox "The specified image cannot be loaded." & vbCrLf & _
             "Please select a valid image.", vbExclamation
    End If
  End If
